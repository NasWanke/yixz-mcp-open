/**
 * YIXZ Badge Vite Plugin
 * 自定义 Badge 插件
 */

import type { Plugin } from 'vite';

export interface YixzBadgePluginOptions {
  /** 主题变体 */
  variant?: 'light' | 'dark';
  /** 位置 */
...
// YIXZ Logo SVG - 用户提供的自定义图标
const YIXZ_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="44 20 112 116">
  <!-- Squircle Head -->
  <rect
    x="56"
    y="44"
...
// 取消按钮 SVG - 深色主题
const CANCEL_SVG_DARK = `<svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
// 取消按钮 SVG - 浅色主题
const CANCEL_SVG_LIGHT = `<svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
// 外部链接图标
const EXTERNAL_LINK_ICON = `<svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function yixzBadgePlugin(options: YixzBadgePluginOptions = {}): Plugin {
  const config: Required<YixzBadgePluginOptions> = {
    variant: 'dark',
    position: 'bottom-right',
    clickable: true,
    clickUrl: 'https://yixz.me',
    disabled: false,
    prodOnly: false,
    autoTheme: true,
    autoThemeTarget: '#app',
          ...
          <script>
            (function() {
              ...
              function createBadge() {
                ...
                badge.className = \`yixz-badge yixz-badge--\${variant} yixz-badge--${config.position}\`;
                badge.innerHTML = \`
...
export default yixzBadgePlugin;
